...
playground.register_shape('C:\\Project\\PH-Code\\Python\\test\\tom.gif')
playground.register_shape('C:\\Project\\PH-Code\\Python\\test\\jerry.gif')
...
tom=turtle.Turtle()
tom.shape('C:\\Project\\PH-Code\\Python\\test\\tom.gif')
tom.penup()
...
jerry=turtle.Turtle()
jerry.shape('C:\\Project\\PH-Code\\Python\\test\\jerry.gif')
jerry.speed(0)
jerry.penup()
